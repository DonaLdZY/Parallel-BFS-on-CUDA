...
void bfs_parallel(int n, int m, int *index, int *edge, int *result) {
    queue<int> bfs;
    bfs.push(0);
...
int main() {
    ...
    string file_out = "result/oepnmp_" + file;
